 ...
 */
// module dependencies
var vm = require('vm'), mongoose = require('mongoose'), async = require('async'), _ = require('lodash'), Q = require('q'), objectAssign = require('object-assign');
module.exports = (function () {
    ...
    var _this = {
                    ...
                    async.series([
                        ...
                        function (callback) {
                            async.eachSeries(Object.keys(value), function (k, innerNext) {
                                var modelData = value[k], data = _this._unwind(modelData);
                                // Create the model
        ...
        _findReference: function (ref) {
            var keys = ref.split('.'), key = keys.shift(), result = _this.result[key];
            if (!result) {
...
//# sourceMappingURL=mongoose-seeder.js.map